...
% Nevertheless, not all methods for automated music generation use deep learning. Musical pieces itself can be generated with genetic algorithms \cite{felice2002genorchestra} or HMMs (Hidden Markov Models) \cite{farbood2001analysis}
